...
RUN echo 'cat //html/body/div[2]/div/main/div[1]/div[2]/div/div[3]/div/div[2]/div/div[2]/div/div[1]/div/div/div/div/a/@rel' | xmllint --html --shell fucitrix.html 2>/dev/null | grep rel | cut -d\" -f2 | sed -e 's/^/https:/' | xargs wget -O citrix.rpm 
